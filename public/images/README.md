# Images for Elad Kids Games

| Asset           | Folder                 | File          |
|-----------------|------------------------|---------------|
| Homepage hero   | `home/`                | `homepage.png`|

Drop game images into the folder they belong to.

| Section   | Game              | Folder                         | Files needed                          |
|-----------|-------------------|--------------------------------|--------------------------------------|
| Hebrew    | Tap the Letter    | `hebrew/tap-the-letter/`       | (future use)                         |
| Hebrew    | First Letter      | `hebrew/first-letter/`         | cat.png, dog.png, sun.png, star.png, bear.png, elephant.png, apple.png, house.png |
| Hebrew    | Build the Word    | `hebrew/build-the-word/`       | house.png, bear.png, sun.png, cat.png, dog.png, elephant.png |
| Maths     | Count the Objects | `maths/count-the-objects/`     | `apple.png`                          |
| Maths     | Ice Cream Seller  | `maths/ice-cream-seller/`       | `ice-cream.png`                      |
